...
public class ECoreGenTerraformProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenTerraformProcessorsFactory(requirement.requirement().context()))));
	}
