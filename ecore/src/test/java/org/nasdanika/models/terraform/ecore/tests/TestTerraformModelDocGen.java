package org.nasdanika.models.terraform.ecore.tests;
...
import org.nasdanika.models.terraform.ecore.EcoreGenTerraformProcessorsFactory;
 ...
 *
 */
public class TestTerraformModelDocGen {
	
	@Test
	public void testGenerateTerraformModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenTerraformProcessorsFactory ecoreGenProcessorFactory = new EcoreGenTerraformProcessorsFactory(context);		
		...
		String siteMapDomain = "https://terraform.models.nasdanika.org";		
